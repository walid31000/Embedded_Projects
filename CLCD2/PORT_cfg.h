...
/*configure pin Initial Value :option :A-In case pin is input:1-FLOATING
                                                             2-PULLEDUP
...
#define PORTA_PIN3_INITVAL                     PULLEDUP
#define PORTA_PIN4_INITVAL                     FLOATING
#define PORTA_PIN5_INITVAL                     FLOATING
#define PORTA_PIN6_INITVAL                     PULLEDUP
...
#define PORTC_PIN6_INITVAL                     PULLEDUP
