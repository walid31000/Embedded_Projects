...
/*configur pin Initial Value :option :A-In case pin is input:1-FLOATING
                                                             2-PULLEDUP
...
#define PORTB_PIN0_INITVAL                      PULLED_UP
#define PORTB_PIN1_INITVAL                      PULLED_UP
#define PORTB_PIN2_INITVAL                      PULLED_UP
